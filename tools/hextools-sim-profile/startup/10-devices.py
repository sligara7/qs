...
# The sim's blackhole IOC serves the shutter PVs with the wrong CA types for hextools'
# Shutter (Pos-Sts as float, Cmd:*-Cmd as string), so the shutters are mocked here.
